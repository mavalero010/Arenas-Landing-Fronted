        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            <li>
              ...
              >
                <span className='text-white hover-opacity'>                
                  <Icon icon='material-symbols:swap-horiz' className='menu-icon text-white hover-opacity' />
                  Home</span>
            ...
            <li>
              ...
              >
                ...
                <span className='text-white hover-opacity'>
                <Icon icon='solar:home-smile-angle-outline' className='menu-icon text-white hover-opacity' />
                  Inmuebles</span>
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className='text-white hover-opacity'>
                <Icon icon='flowbite:users-group-outline' className='menu-icon text-white hover-opacity' />
                  Testimonios</span>
              </Link>
            </li>
